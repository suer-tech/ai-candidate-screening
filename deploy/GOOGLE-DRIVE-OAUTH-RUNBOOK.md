...
3. Оставить `CANDIDATE_PIPELINE_ROUTING=disabled`, выполнить preflight и consent владельца.
...
5. Возобновлять с `disabled`; в `effectful` переходить только после повторного GREEN.
