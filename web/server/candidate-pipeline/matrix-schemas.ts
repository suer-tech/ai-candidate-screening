export const MATRIX_CAPABILITY_SCHEMAS = {
  ...
  matrix_row_evaluation: "candidate-matrix-rows/v1",
...
export function normalizeMatrixCapabilityOutput(capability: MatrixCapability, input: unknown) {
  ...
  switch (capability) {
    ...
    case "matrix_critic":
      ...
      break;
    case "criterion_claim_extraction": array(source.claims, "claims"); break;
    ...
    case "matrix_row_evaluation": case "invalid_row_repair": array(source.rows, "rows"); break;
