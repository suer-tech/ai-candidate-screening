...
export type CandidatePipelineRoutingMode = "disabled" | "effectful";
...
export function candidatePipelineReadiness(environment: CandidatePipelineEnvironment) {
  ...
  if (mode !== "effectful") return { ready: false as const, mode: "disabled" as const, missing: [] as Array<keyof CandidatePipelineEnvironment>, reason: "INVALID_ROUTING_MODE", runtimeContract: CANDIDATE_PIPELINE_RUNTIME_CONTRACT };
