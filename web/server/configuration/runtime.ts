...
export function environmentProjection(configuration: RuntimeConfiguration): Record<string, string> {
  ...
  const llmConfiguration = {
    ...
    capabilities: {
      ...
      criterion_claim_extraction: capability("extract-claims-for-criteria/v1", "candidate-claims/v1", 1),
      unmapped_signal_discovery: capability("discover-unmapped-signals/v1", "candidate-unmapped-signals/v1", 1),
      ...
      evidence_consolidation: capability("consolidate-evidence/v1", "candidate-evidence-consolidation/v1", 1),
      global_conflict_detection: capability("detect-global-conflicts/v1", "candidate-global-conflicts/v1", 1),
      matrix_row_evaluation: capability("fill-matrix-rows/v1", "candidate-matrix-rows/v1", 1),
      abc_matrix_assessment: capability("assess-abc-direction/v1", "candidate-abc-matrix/v1", 1),
      critical_row_verification: capability("verify-critical-row/v1", "candidate-row-verification/v1", 1),
      invalid_row_repair: capability("repair-invalid-rows/v1", "candidate-matrix-rows/v1", 1),
    },
  };
